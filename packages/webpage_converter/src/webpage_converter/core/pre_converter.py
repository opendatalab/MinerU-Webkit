...
class HTMLFileFormatFilterPreConverter(BaseFileFormatFilterPreConverter):
...
class HTMLFileFormatNoClipFilterTablePreConverter(HTMLFileFormatFilterPreConverter):
    def __init__(self, config: dict):
        super().__init__(config)
...
class HTMLFileFormatNoClipCleanTagsPreConverter(HTMLFileFormatFilterPreConverter):
    """清理html中隐藏标签."""
...
class TestHTMLFileToDataJsonPreConverter(HTMLFileFormatFilterPreConverter):
...
class HTMLFileFormatNoClipPreConverter(HTMLFileFormatFilterPreConverter):
