...
class StructureMapper(ABC):
    ...
    def __init__(self):
        ...
        self.__nodes_document_type = [
            DocElementType.MM_NODE_LIST,
            DocElementType.PARAGRAPH,
            DocElementType.LIST,
            DocElementType.SIMPLE_TABLE,
            DocElementType.COMPLEX_TABLE,
            DocElementType.TITLE,
            DocElementType.IMAGE,
            DocElementType.AUDIO,
            DocElementType.VIDEO,
            DocElementType.CODE,
            DocElementType.EQUATION_INTERLINE,
        ]
        self.__inline_types_document_type = [
            ParagraphTextType.EQUATION_INLINE,
            ParagraphTextType.CODE_INLINE,
        ]
    ...
    def to_plain_md(
        self,
        exclude_nodes=DocElementType.EXCLUDE_PLAIN_MD_LIST,
        exclude_inline_types=DocElementType.EXCLUDE_PLAIN_MD_INLINE_LIST,
    ...
    def __content_lst_node_2_md(
        self,
        content_lst_node: dict,
        exclude_inline_types: list = [],
        use_raw_image_url=False,
    ) -> str:
