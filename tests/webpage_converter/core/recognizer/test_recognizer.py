...
class TestBaseHTMLElementRecognizer(unittest.TestCase):
    def test_html_split_by_tags_1(self):
        with open(core_path / 'assets/recognizer/image.html', 'r') as file:
    ...
    def test_html_split_by_tags_2(self):
        with open(core_path / 'assets/recognizer/cccode.html', 'r') as file:
            html_content = file.read()
    ...
    def test_html_split_by_tags_3(self):
        with open(core_path / 'assets/recognizer/raw_html_attr.html', 'r') as file:
            html_content = file.read()
    ...
    def test_html_split_by_tags_with_parent_nodes(self):
        """测试是否能够正确带上父节点."""
        with open(core_path / 'assets/recognizer/with_parent_nodes.html', 'r') as file:
            html_content = file.read()
    ...
    def test_is_cctag(self):
        with open(core_path / 'assets/recognizer/iscctag.html', 'r') as file:
            html_content = file.read()
