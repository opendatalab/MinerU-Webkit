...
TEST_CASES = [
    {
        ...
        'expected': [
            ('assets/table/table_to_content_list_simple_res.json'),
            ('assets/table/table_to_content_list_complex_res.json'),
            ('assets/table/table_include_image_expcet.json'),
            ('assets/table/table_include_code_expect.json')
        ],
    }
]
